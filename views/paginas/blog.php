...
?>
  ...
  <nav class="nav navbar navbar-expand-lg d-lg-flex flex-lg-column align-items-lg-start">
    <div class="container-fluid d-flex justify-content-end display-lg-none">
      ...
      <a class="gray-opacity margin-left-20" target="_blank" href="https://api.whatsapp.com/send?phone=928393730&text=Hola, ¿me puedes ayudar?">Envíame un mensaje</a>
      <a class="gray-opacity margin-left-20" target="_blank" href="https://wa.me/928393730?text=Hola, ¿me puedes ayudar?">Envíame un mensaje</a>
    </div>
